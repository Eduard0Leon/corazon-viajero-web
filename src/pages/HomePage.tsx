        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Descubre los destinos más populares y las mejores ofertas disponibles para tu próxima aventura.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105">
              <div className="relative h-64">
                <img src="/images/orlando.jpg" alt="Orlando" className="w-full h-full object-cover" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                  <h3 className="text-xl font-bold text-white">Orlando, Florida</h3>
                  <p className="text-white/80">Parques temáticos y diversión familiar</p>
                </div>
              </div>
              <div className="p-4">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105">
              <div className="relative h-64">
                <img src="/images/miami.jpg" alt="Miami" className="w-full h-full object-cover" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                  <h3 className="text-xl font-bold text-white">Miami, Florida</h3>
                  <p className="text-white/80">Playas, sol y vida nocturna</p>
                </div>
              </div>
              <div className="p-4">
                <div className="flex justify-between items-center mb-2">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105">
              <div className="relative h-64">
                <img src="/images/cancun.jpg" alt="Cancún" className="w-full h-full object-cover" />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                  <h3 className="text-xl font-bold text-white">Cancún, México</h3>
                  <p className="text-white/80">Playas paradisíacas y cultura maya</p>
                </div>
              </div>
              <div className="p-4">
                <div className="flex justify-between items-center mb-2">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Descubre por qué miles de viajeros confían en Corazón Viajero para planificar sus vacaciones soñadas.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6 shadow-md">
              <div className="flex items-center mb-4">
                <img src="/images/testimonial_maria.jpg" alt="María Rodríguez" className="h-12 w-12 rounded-full object-cover" />
                <div className="ml-4">
            ...
            <div className="bg-gray-50 rounded-lg p-6 shadow-md">
              <div className="flex items-center mb-4">
                <img src="/images/testimonial_carlos.jpg" alt="Carlos Mendoza" className="h-12 w-12 rounded-full object-cover" />
                <div className="ml-4">
              ...
              <p className="text-gray-600 italic">
                "Las playas de Miami son espectaculares y gracias a este certificado pudimos hospedarnos en un hotel frente al mar. El ahorro fue significativo y el servicio de Corazón Viajero fue excelente de principio a fin."
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 shadow-md">
              <div className="flex items-center mb-4">
                <img src="/images/testimonial_ana.jpg" alt="Ana Sánchez" className="h-12 w-12 rounded-full object-cover" />
                <div className="ml-4">
                  <h4 className="font-semibold text-gray-800">Ana Sánchez</h4>
                  <div className="flex text-yellow-400">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-cyan-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Contacta con nosotros hoy mismo y comienza a planificar tu próximo viaje con increíbles descuentos.
          </p>
